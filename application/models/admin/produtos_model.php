<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Produtos_model extends CI_Model {
		...
		*
		******/
		public function listarProdutos($id = null)
		{
		...
		*
		******/
		public function listarProdutosSubCategoria($id_sub_categoria){

			$this->db
				->select('a.*, b.str_nome as str_cat, c.str_nome as str_sub_categoria')
				->from('tb_produtos a')
				->join('tb_categorias as b', 'b.id = a.id_categoria')
				->join('tb_sub_categorias  as c', 'c.id = a.id_sub_categoria')
				->where('a.int_ativo', 1)
				->where('a.id_sub_categoria', $id_sub_categoria)
				->order_by('a.int_ordem', 'asc');
		...
		******/
		...
		/***
		* LISTA AS SUB-CATEGORIAS ATIVAS
		*
		*
		*
		******/
	 ...
	 //    	$this->db->select('a.id, a.id_categoria, c.str_slug as slug_cat, d.str_slug as slug_sub, a.id_sub_categoria, a.str_nome as nome_produto, a.str_codigo, a.txt_visao_geral, a.int_ativo, b.str_imagem, a.str_slug as slug_produto');
	  ...
	  //   	$this->db->select('a.id, a.id_categoria, c.str_slug as slug_cat, d.str_slug as slug_sub, a.id_sub_categoria, a.str_nome as nome_produto, a.str_codigo, a.txt_visao_geral, a.int_ativo, b.str_imagem, a.str_slug as slug_produto');
			...
			// $this->db->order_by('a.int_ordem', 'asc');

			// $query = $this->db->get('tb_produtos a', 12, $offset);
	  ...
	  //   }
		...
		*
		******/
	    public function listarUltimosProdutos()
	    {
		...
		*
		******/
	    public function buscaProdutoSlug($str_slug)
	    {

	    	$this->db->select('a.id, a.id_categoria, c.str_slug as slug_cat, d.str_slug as slug_sub, a.id_sub_categoria, a.str_nome as nome_produto, a.txt_descricao, a.int_ativo, b.str_imagem, a.str_slug as slug_produto, a.str_title, a.str_keywords, a.str_description');

			$this->db->where('a.int_ativo', 1);
			$this->db->where('c.int_ativo', 1);
			$this->db->where('d.int_ativo', 1);

			$this->db->where('a.str_slug', $str_slug);
		...
		*
		******/
	    public function listaProdutosSubSlug($str_slug)
	    {
			...
			$this->db->where('d.str_slug', $str_slug);
	    ...
	    /***
	    * TOTAL DE ITENS NA PAGINAÇÃO DA PÁGINA DE PRODUTOS INICIAL 
	    *
	    *
		*
		*
		******/
	    ...
	    /***
	    * query da paginação
	    * resultado de todos os produtos por id_categoria e id_sub_categoria
	    *
		*
		*
		******/
		...
		******/
		public function listarProdutosFront($slug)
		{
			...
			$this->db
				->select('a.*, b.str_slug as slug_cat, b.str_nome as nome_categoria, c.str_nome as sub_categoria_nome, c.str_slug as slug_sub, b.str_nome as str_categoria, c.str_nome as str_sub_categoria')
				->from('tb_produtos a')
				->join('tb_categorias      as b', 'b.id = a.id_categoria', 'left')
				->join('tb_sub_categorias  as c', 'c.id = a.id_sub_categoria', 'left')
				->where('a.int_ativo', 1)
		...
		*
		******/
		public function listarProdutosRelacionados($id_sub_categoria, $id_produto)
		{
		...
		*
		******/
		public function listarProdutosDestaqueHome()
		{
			...
			$this->db->where('a.int_ativo', 1);
			$this->db->where('a.int_destaque', 1);
		...
		******/
		...
		public function listarDownloadsPagina()
		{
		...
		public function listarDownloadsBusca()
		{
